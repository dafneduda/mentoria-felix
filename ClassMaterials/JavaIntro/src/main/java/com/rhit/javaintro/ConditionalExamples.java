...
public class ConditionalExamples {
	...
	public static void main(String[] args) {
		...
		System.out.println("Is 1, 2 or 3 greater than 3? " + isGreaterThan3(1, 2, 3)); // should return false
		System.out.println("Is 4, 5 or 6 greater than 3? " + isGreaterThan3(4, 5, 6)); // should return true
		System.out.println("Is 1, 2 or 4 greater than 3? " + isGreaterThan3(1, 2, 4)); // should return true
	}
