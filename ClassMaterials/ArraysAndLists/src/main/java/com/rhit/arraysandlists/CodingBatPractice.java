...
public class CodingBatPractice {
   ...
   * <p>
   * public       = method can be accessed from any other class (anywhere) start, end   = input
   * parameters int[]        = return type  (this method returns an int array) static       =
   * because main is static (we will learn about static more later in the course)
   */
