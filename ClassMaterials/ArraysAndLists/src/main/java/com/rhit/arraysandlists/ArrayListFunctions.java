...
public class ArrayListFunctions {
  ...
  /**
   * Write a function that takes an array of strings and return an arraylist. The arraylist should
   * contain only the strings in the original list that begin with 'A'
   * <p>
  ...
  /**
   * Takes an arrayList of numbers in sorted (ascending) order and a number to add. Adds the number
   * in the correct place in the sorted list.
   * <p>
...
//        }
  ...
  public static void removeLongStrings(ArrayList<String> strings) {
    ...
    for (int indice = strings.size() - 1; indice >= 0; indice--) {
      if (strings.get(indice).length() >= 3) {
