 ...
 * @author wilkin
 * <p>
 * Use this for in-class examples.  I create this whole class from scratch in front of them.
 * Comments I make as I go along that leads into the next thing are in code comments below. Just
 * follow this from top-to-bottom in main and it is the same sequential order I use.
 */
public class ArrayWithMap {
  ...
  public static void main(String[] args) {
    // region PART-1: This code and the printNext method below code we will remake using a map:
    ...
    // region PART-2: this will be equivalent to an int array
    ...
    // A Great exercise is to make them match the pretty print of a map as in above to practice the get method
    ...
    // region PART-3: Now do the same for 5 elements, but spell the word out:
    ...
    for (String key : myArray2.keySet()) {
      // me de todas as chaves: {zero, one, two...}
      // para cada chave = zero, ...
      // mapa[zero] = 0;
    ...
    // region PART-4: (replace 2nd half of part 3 with this)
