...
public class HW1 {
    ...
    /**
     * main method tests the twoEven method by using hardcoded numbers as the
     * parameters. The tests are checked by printing the return values in the
     * console.
     */
    public static void main(String[] args) {
        ...
        test = twoEven(18, 122, 311);
        System.out.println("18, 122, 311");
        if (test) System.out.println("TRUE");
        else System.out.println("FALSE");
        System.out.println("----------------------");

        test = twoEven(10000001, 99999999, 3);
        System.out.println("10000001, 99999999, 3");
        if (test) System.out.println("TRUE");
        else System.out.println("FALSE");
        System.out.println("----------------------");

        test = twoEven(12, 24, 36);
        System.out.println("12, 24, 36");
        if (test) System.out.println("TRUE");
        else System.out.println("FALSE");
        System.out.println("----------------------");

        test = twoEven(10000000, 88888, 2);
        System.out.println("10000000, 88888, 2");
        if (test) System.out.println("TRUE");
        else System.out.println("FALSE");
        System.out.println("----------------------");

        test = twoEven(74, 28, 3);
        System.out.println("74, 28, 3");
        if (test) System.out.println("TRUE");
        else System.out.println("FALSE");
        System.out.println("----------------------");
    }
...
//        return count == 2;
    ...
    public static int footballScore(String input) {
        ...
        for(int index = 0; index < input.length(); index++) {
            if (input.charAt(index) == 'F') totalScore += 3;
            if (input.charAt(index) == 'T') totalScore += 7;
        }
        return totalScore;
    }
}
