...
public class HW1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("| %22s | %-8s | %-8s |%n", "10000001, 99999999, 3", false, twoEven(10000001, 99999999, 3));
        System.out.printf("| %22s | %-8s | %-8s |%n", "12, 24, 36", false, twoEven(12, 24, 36));
        System.out.printf("| %22s | %-8s | %-8s |%n", "10000000, 88888, 2", false, twoEven(10000000, 88888, 2));
