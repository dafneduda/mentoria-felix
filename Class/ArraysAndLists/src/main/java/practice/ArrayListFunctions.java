...
public class ArrayListFunctions {
    ...
    /**
     *
     * Write a function that takes an array of strings and return an arraylist.
     * The arraylist should contain only the strings in the original list that begin with 'A'
     *
    ...
    /**
     * Takes an arrayList of numbers in sorted (ascending) order and a number to add.
